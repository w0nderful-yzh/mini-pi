...
│   │   └── sections.py               # section diff / patch / replay
│   │
│   └── workspace/
...
| M7 | Session / Context：JSONL entry 树、AGENTS.md、resume、compaction | 进行中（M7.1、M7.2a-M7.2c 已完成） |
| M8 | LSP / MCP | 未开始 |
| M9 | Task / Memory | 未开始 |
| M10 | Multi-Agent | 未开始 |
