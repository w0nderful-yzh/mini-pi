...
def summarize_transcript(llm: LLMClient, transcript: str) -> SummaryResult:
    ...
    response = llm.complete(_build_messages(transcript), None)
...
def _build_messages(transcript: str) -> list[Message]:
